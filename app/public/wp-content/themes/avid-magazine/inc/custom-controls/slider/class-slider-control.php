...
if ( ! class_exists( 'Avid_Magazine_Slider_Control' ) ) {

	/**
	 * Slider control (range).
	 */
	class Avid_Magazine_Slider_Control extends Wp_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'avid-magazine-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'avid-magazine-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
